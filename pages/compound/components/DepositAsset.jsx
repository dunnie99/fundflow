          ...
          <div className="w-[90%] mx-auto">
            ...
            <div className="pt-4 pb-4 border-t-[1px] border-b-[1px] border-[#ACAFC9]">
              <div className="w-[85%] mx-auto text-[#585E92] flex gap-2 items-center">
                ...
                <input
                  ...
                  placeholder="0.00"
                  className="text-[24px] font-normal border-l-0 outline-none w-full"
                />
              </div>
            ...
            <div className="w-[80%] mx-auto flex gap-6 pt-6 pb-6">
              <button
                ...
                className="w-[182px] h-[52px] px-2 text-[24px] rounded-2xl bg-[#ACAFC9] font-normal font-secondary leading-9 text-[#040C4D]"
              >
                Deposit
              </button>
              <button className="w-[182px] px-2 h-[52px] text-[24px] rounded-2xl bg-[#ACAFC9] font-normal font-secondary leading-9 text-[#040C4D]">
                Withdraw
              </button>
            </div>
          </div>
