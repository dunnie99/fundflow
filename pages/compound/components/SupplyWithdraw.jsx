        ...
        <section className='w-[100%] '>
            ...
            <div className="w-[90%] mx-auto">
                ...
                <div className="w-[80%] mx-auto flex gap-6 pt-6 pb-6">
                  <button onClick={handleSupply} className='w-[182px] h-[52px] text-[24px] rounded-2xl bg-[#ACAFC9] font-normal font-secondary leading-9 text-[#040C4D]'>{isLoading || cwriteLoading?"Supply...": "Supply"}</button>
                  <button onClick={handleWithdraw} className='w-[182px] h-[52px] text-[24px] rounded-2xl bg-[#ACAFC9] font-normal font-secondary leading-9 text-[#040C4D]'>{withdrawWaitLoading || withdrawLoading?"Withdraw ..." : "Withdraw"}</button>
                </div>
            </div>
